...
// Initiate the add-on
class Group_Buying_Query_Optimization_Addon extends Group_Buying_Controller {
	...
	public static function gb_add_on( $addons ) {
		$addons['query_optimization_beta'] = array(
			'label' => self::__( 'Advanced: Query Optimization (beta)' ),
